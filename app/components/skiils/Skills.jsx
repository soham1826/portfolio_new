...
const Skills = ({skills}) => {
  ...
  return (
    ...
    className="flex relative flex-col xl:flex-row max-w-[2000px] xl:px-10 min-h-[500px] xl:justify-center justify-start xl:space-y-0 mx-0 items-center text-2xl mt-3">
    
      <div className="grid xl:grid-cols-6 lg:grid-cols-6 md:grid-cols-5 grid-cols-5 gap-3">
