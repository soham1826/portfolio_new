...
const Skills = () => {
  return (
    ...
    className="h-screen flex relative flex-col md:text-left xl:flex-row max-w-[2000px] xl:px-10 min-h-screen justify-center xl:space-y-0 mx-0 items-center text-2xl">
